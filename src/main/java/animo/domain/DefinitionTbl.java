...
public class DefinitionTbl {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "id_key_gen_definition"  )
    @SequenceGenerator(name = "id_key_gen_definition", sequenceName = "definition_idn_seq", allocationSize=1)
    @Column(name = "idn")
    private Integer idn;
