...
public class DefinitionTbl {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "id_key_gen_defenition"  )
    @SequenceGenerator(name = "id_key_gen_defenition", sequenceName = "definition_idn_seq", allocationSize=1)
    @Column(name = "idn")
    private Integer idn;
